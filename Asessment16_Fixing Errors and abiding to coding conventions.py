...
class Window_one:
     def __init__(self):
          ...
          canvas.create_window(400,230,window=self.entry_left,width=50)
          ...
          canvas.create_window(400,20,window=level_one,width=300)
          ...
          canvas.create_window(400,50,window=level_two,width=300)
          ...
          canvas.create_window(400,80,window=level_three,width=300)
          ...
          canvas.create_window(400,110,window=level_four,width=300)
     ...
     def procedural_generation(self):
          ...
          self.question_counter_text = canvas.create_text(300,200, tag="text", text="Question {}".format(self.question_counter))
          if self.level < 4: 
               self.text = canvas.create_text(400,200, tag="starting_text", text=self.edit_line+" =")
          else:
               self.text = canvas.create_text(400,200, tag="starting_text", text=self.edit_line)
          print(line)
     ...
     def right(self):
          ...
          incorrect_correct = canvas.create_text(500,200, tag="text", text="Correct!")
          '''
     ...
     def wrong(self): 
          ...
          incorrect_correct = canvas.create_text(500,200, tag="text", text="Incorrect!")
          '''
     ...
     def answers(self):
          ...
          if self.level < 4: 
               self.text = canvas.create_text(400,200, tag="text", text=self.edit_line+"=")
